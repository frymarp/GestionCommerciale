...
namespace GestionCommerciale.Infrastructure
{
    ...
    public class InMemoryClientRepository : IClientRepository
    {
        ...
        public Task<Client?> GetAsync(Guid id, Guid organizationId) =>
            Task.FromResult(_clients.FirstOrDefault(c => c.Id == id && c.OrganizationId == organizationId));
        ...
        public Task<List<Client>> ListAsync(Guid organizationId) =>
            Task.FromResult(_clients.Where(c => c.OrganizationId == organizationId).ToList());
